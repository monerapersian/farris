...
urlpatterns = [
    ...
    path(r'^products/?$', views.products_list, name='products_list'),
    path('products/<slug:slug>/', views.product_detail, name='product_detail'),
    path(r'^articles/?$', views.articles_list, name='articles_list'),
    path('articles/<slug:slug>/', views.article_detail, name='article_detail'),
    path(r'^tutorial/?$', views.tutorial, name='tutorial'),
    path(r'^call_us/?$', views.call_us, name='call_us'),
    path(r'^cart/?$', views.cart_page, name='cart_page'),
    ...
    path(r'^agency-request/?$', views.agency_request_view, name='agency_request'),
